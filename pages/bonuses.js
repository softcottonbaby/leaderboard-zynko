...
// Helper component for a professional copy icon
const CopySvgIcon = ({ className }) => (
  <svg
    ...
    const bonusSites = [
        {
            ...
            codeContainerStyle: 'bg-[#0a0000] border border-red-700', // Red theme for Clash
        ...
        },
        {
            ...
            codeContainerStyle: 'p-[2px] bg-gradient-to-r from-blue-700 to-cyan-700', // Darker blue gradient border for Chips
            ...
            <main className="flex-grow w-screen max-w-screen flex flex-col items-center text-center px-4 pt-32 relative z-10 pb-24">
                ...
                <section className="w-full max-w-5xl px-4 text-white mt-6">
                    ...
                    <div className="flex flex-wrap justify-center gap-8">
                        {bonusSites
                            .filter((site) => showBonuses[site.id])
                            .map((site) => (
                                <div
                                    key={site.id}
                                ...
                                >
                                    <div
                                        className="relative bg-black/80 backdrop-blur-sm rounded-xl p-6 h-full w-full"
                                    >
                                                    ...
                                                    <AnimatePresence mode="wait">
                                                        {copiedState[site.id] ? (
                                                            ...
                                                            >
                                                                ...
                                                                <button
                                                                    onClick={() => copyCode(site.id, site.code)}
